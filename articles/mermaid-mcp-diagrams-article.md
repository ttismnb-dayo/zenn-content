...
諦めてMermaid + Claude Code + diagrams.net に寄せた運用にしてみたところ、
...
TL;DR（先に結論）
	...
	•	Claude Code には Mermaid までやってもらう
...
まとめ
	•	構成図は「全部自動化」しなくていい
	•	Claude Code は 構造を固めるところまでがちょうどいい
